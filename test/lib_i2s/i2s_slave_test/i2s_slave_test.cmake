...
foreach(i RANGE 1 ${num_pairs})
    ...
    foreach(bd ${BITDEPTHS})
        foreach(test_level ${TEST_LEVELS})
            set(TARGET_NAME "test_hil_i2s_slave_test_${bd}_${test_level}_${num_in}_${num_out}")
            ...
            set(TARGET_NAME "test_hil_i2s_slave_test_${bd}_${test_level}_${num_in}_${num_out}_inv")
            add_executable(${TARGET_NAME} EXCLUDE_FROM_ALL)
            target_sources(${TARGET_NAME} PUBLIC ${APP_SOURCES})
            target_include_directories(${TARGET_NAME} PUBLIC ${APP_INCLUDES})
            target_compile_definitions(${TARGET_NAME}
