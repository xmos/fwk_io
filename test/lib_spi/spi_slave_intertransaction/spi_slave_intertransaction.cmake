        ...
        foreach(mosi ${MOSI_ENABLED})
            foreach(mode ${SPI_MODE})
                foreach(in_place ${IN_PLACE})
                    set(TARGET_NAME "test_hil_spi_slave_intertransaction_${load}_${miso}_${mosi}_${mode}_${in_place}")
                    ...
                    target_link_libraries(${TARGET_NAME} PUBLIC lib_spi framework_core_utils)
