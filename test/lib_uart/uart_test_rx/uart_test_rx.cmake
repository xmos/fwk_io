...
if(NOT DEFINED ENV{TEST_BAUD})
    set(TEST_BAUD 1843200 1152000 921600 806400 700000 576000 460800 422400 115200 9600)
else()
        ...
        foreach(data ${TEST_DATA_BITS})
            foreach(parity ${TEST_PARITY})
                foreach(stop ${TEST_STOP_BITS})
                    set(TARGET_NAME "test_hil_uart_rx_test_${buffer}_${baud}_${data}_${parity}_${stop}")
                    ...
                    target_link_libraries(${TARGET_NAME} PUBLIC lib_uart framework_core_utils)
